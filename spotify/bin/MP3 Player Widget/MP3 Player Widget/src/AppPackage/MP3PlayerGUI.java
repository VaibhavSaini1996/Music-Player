...
public class MP3PlayerGUI extends javax.swing.JDialog
{
    ...
    private void SelectFileMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SelectFileMouseReleased
        ...
        if (returnval == JFileChooser.APPROVE_OPTION)
        {
            ...
            //stops previous song so that it doesnt continue playing in a diffrent thread
            MC.stop();

            //displays name of the song on the text label
            String name = chooser.getSelectedFile().getName();
            Display.setText(name); //if we dont want to show the extension, remove everythign after the dot
